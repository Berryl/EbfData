...
class TestSnapshotPricingTable:
    ...
    class TestSelectedPriceUpdate:
        ...
        def _select_ws_rows(self, sut: SnapshotScenario_EquityPricing, ws_rows: list[int]) -> None:
        ...
        @pytest.fixture(scope="class")
        def single_row_result(self, sut: SnapshotScenario_EquityPricing) -> tuple[
        ...
        @pytest.fixture(scope="class")
        def two_row_result(self, sut: SnapshotScenario_EquityPricing) -> tuple[
            SnapshotScenario_EquityPricing, PriceUpdateResult]:
